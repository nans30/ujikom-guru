        ...
        var e = (e, t) => {
            ...
            e =
                (e &&
                    e.addEventListener("click", () => {
                        var e =
                            "light" === this.config.theme ? "dark" : "light";
                        this.changeTheme(e);
                    }),
...
const STORAGE_KEY = "Langguage";
class I18nManager {
    constructor({
        defaultLang: e = "en",
        langPath: t = "/admin/assets/data/translations/",
        ...
        (this.selectedLanguage = localStorage.getItem(STORAGE_KEY) || e),
            (this.langPath = t),
    ...
    async applyTranslations() {
        ...
        document.querySelectorAll(this.translationKeySelector).forEach((e) => {
            ...
            a
                ? (e.innerHTML = a)
                : console.warn("Missing translation for key: " + t);
        });
    }
    setLanguage(e) {
        (this.selectedLanguage = e),
            localStorage.setItem("Langguage", e),
