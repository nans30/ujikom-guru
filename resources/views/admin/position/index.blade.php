@extends('layouts.admin', ['title' => 'Position'])
...
@section('content')
    @include('admin.partials.page-title', ['subtitle' => 'Apps', 'title' => 'Position'])
            ...
            <div data-table class="card">
                <div class="card-header border-light justify-content-between">
                    <div class="d-flex gap-2">
                        <div class="app-search">
                            <input data-table-search type="search"
                                   ...
                                   style="max-width: 140px; font-size: 0.85rem;" placeholder="Search position...">
                        </div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('admin.position.create') }}" class="btn btn-secondary">Add Position</a>
                    </div>
                </div>
