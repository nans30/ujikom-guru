    ...
    <div class="col-sm-12">
        ...
        <div class="mb-3">
            ...
            <textarea
                ...
                class="form-control"
                rows="3"
            >{{ old('reason', optional($attendance)->reason) }}</textarea>
        </div>
        ...
        <div class="mb-3">
            ...
            @if (!empty(optional($attendance)->photo_check_in))
                <div class="mb-2">
                    <img
                        src="{{ asset('storage/' . $attendance->photo_check_in) }}"
                        class="img-thumbnail"
        ...
        <div class="mb-3">
            ...
            @if (!empty(optional($attendance)->photo_check_out))
                <div class="mb-2">
                    <img
                        src="{{ asset('storage/' . $attendance->photo_check_out) }}"
                        class="img-thumbnail"
                        style="max-height:160px"
                    >
                </div>
        ...
        <div class="mb-3">
            ...
            @if (!empty(optional($attendance)->proof_file))
                <div class="mb-2">
                    <a
                        href="{{ asset('storage/' . $attendance->proof_file) }}"
                        target="_blank"
