...
@section('content')
    @include('admin.partials.page-title', ['subtitle' => 'Pages', 'title' => 'Create Page'])
        ...
        <div class="row">
            <div class="col-sm-12">
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row custom-input" action="{{ route('admin.page.store') }}" id="createPageForm"
