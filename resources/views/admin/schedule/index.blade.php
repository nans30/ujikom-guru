@extends('layouts.admin', ['title' => 'Schedule'])
...
@section('content')
    @include('admin.partials.page-title', ['subtitle' => 'Apps', 'title' => 'Schedule'])
            ...
            <div data-table class="card">
                <div class="card-header border-light justify-content-between">
                    <div class="d-flex gap-2">
                        <div class="app-search">
                            <input data-table-search type="search"
                                   ...
                                   style="max-width: 140px; font-size: 0.85rem;" placeholder="Search schedule...">
                        </div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('admin.schedule.create') }}" class="btn btn-secondary">Add Schedule</a>
                    </div>
                </div>
