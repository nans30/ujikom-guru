@extends('layouts.admin', ['title' => 'Edit Journal'])

@section('content')
    @include('admin.partials.page-title', ['subtitle' => 'Journal', 'title' => 'Edit Journal'])
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        <form class="row custom-input"
                              action="{{ route('admin.journal.update', $journal->id) }}"
                              method="POST"
