...
@section('content')
    @include('admin.partials.page-title', ['subtitle' => 'Apps', 'title' => 'Categorie'])
            ...
            <div data-table class="card">
                <div class="card-header border-light justify-content-between">
                    <div class="d-flex gap-2">
                        <div class="app-search">
                            <input data-table-search type="search"
                                   ...
                                   style="max-width: 140px; font-size: 0.85rem;" placeholder="Search categorie...">
                        </div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('admin.categorie.create') }}" class="btn btn-secondary">Add Categorie</a>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            const table = $('#categorie-table').DataTable();
