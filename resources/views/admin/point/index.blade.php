@extends('layouts.admin', ['title' => 'Point'])
...
@section('content')
    @include('admin.partials.page-title', ['subtitle' => 'Apps', 'title' => 'Point'])
            ...
            <div data-table class="card">
                <div class="card-header border-light justify-content-between">
                    <div class="d-flex gap-2">
                        <div class="app-search">
                            <input data-table-search type="search"
                                   ...
                                   style="max-width: 140px; font-size: 0.85rem;" placeholder="Search point...">
                        </div>
                    ...
                    <div class="d-flex align-items-center gap-2">
                        ...
                        <a href="{{ route('admin.point.create') }}" class="btn btn-secondary">Add Point</a>
                    </div>
                </div>
...
@section('scripts')
    ...
    <script>
        $(document).ready(function() {
            const table = $('#point-table').DataTable();
